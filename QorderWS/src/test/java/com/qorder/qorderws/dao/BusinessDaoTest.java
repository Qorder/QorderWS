...
public class BusinessDaoTest {
	...
	@Test
	public void testSuccessUpdateBusiness() throws BusinessDoesNotExistException{
		Business business=this.businessDAO.findById(5);
	...
	@Test
	public void testSuccessfindBusinessById() throws BusinessDoesNotExistException{
		Business business=this.businessDAO.findById(5);
